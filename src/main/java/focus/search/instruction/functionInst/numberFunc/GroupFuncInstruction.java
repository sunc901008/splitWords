...
public class GroupFuncInstruction {
    ...
    // 完整指令 <group-average-function> := group_average ( <number-source-column> , <attribute-list-params> );
    ...
    // 其他指令一部分 <group-average-function>
    ...
    // 其他指令一部分 <group-average-function> := group_average ( <number-source-column> , <attribute-list-params> );
