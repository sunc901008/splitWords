 ...
 * description:
 */
//<ifnull-function> := ifnull ( <number-source-column> , <number-source-column> ) |
//        ifnull ( <number-source-column> , <number> ) |
...
public class IfNullFuncInstruction {
    ...
    public static JSONObject arg(FocusPhrase focusPhrase, List<Formula> formulas) throws FocusInstructionException, IllegalException {
        ...
        args.add(OtherFuncInstruction.arg(param1, formulas));
    ...
    public static List<AnnotationToken> tokens(FocusPhrase focusPhrase, List<Formula> formulas, JSONObject amb) throws FocusInstructionException {
        ...
        tokens.addAll(OtherFuncInstruction.tokens(param1, amb, formulas));
